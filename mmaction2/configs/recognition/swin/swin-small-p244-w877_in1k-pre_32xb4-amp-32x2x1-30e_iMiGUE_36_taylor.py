...
model = dict(
    ...
    cls_head=dict(num_classes=32)
)

# dataset settings
dataset_type = 'VideoDataset'
data_root = '../dataset/Taylor/train'
data_root_val = '../dataset/Taylor/val'
data_root_test = '../dataset/Taylor/test'
ann_file_train = '../dataset/iMiGUE_train_clips_list.txt'
ann_file_val = '../dataset//iMiGUE_val_clips_list.txt'
ann_file_test = '../dataset/iMiGUE_test_clips_list.txt'
